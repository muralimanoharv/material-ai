...
function DynamicMuiLoader({ componentName, ...rest }) {
...
export const LazyMuiComponents = {
    ...
    BottomNavigationAction: lazy(() => import('@mui/material/BottomNavigationAction')),
    ...
    DefaultPropsProvider: lazy(() => import('@mui/material/DefaultPropsProvider')),
    ...
    InitColorSchemeScript: lazy(() => import('@mui/material/InitColorSchemeScript')),
    ...
    ListItemSecondaryAction: lazy(() => import('@mui/material/ListItemSecondaryAction')),
    ...
    OverridableComponent: lazy(() => import('@mui/material/OverridableComponent')),
    ...
    TablePaginationActions: lazy(() => import('@mui/material/TablePaginationActions')),
